...
// Embeddable SVG report-review badge.
// Usage: <img src="https://auditgpt.ai/api/badge/{publicId}" />
//
// The badge states WHAT WAS CHECKED, never "Verified".
// Three states: active review, expired review, no report.
...
<svg width="260" height="64" viewBox="0 0 260 64" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="AuditGPT Report Review">
  ...
  <text x="58" y="22" font-family="-apple-system, system-ui, sans-serif" font-size="10" font-weight="700" fill="#0a0a0a" letter-spacing="0.5">AUDITGPT REPORT REVIEW</text>
...
function buildExpiredSvg(name: string): string {
  const safe = esc(name || 'This business');
  return `<?xml version="1.0" encoding="UTF-8"?>
<svg width="260" height="64" viewBox="0 0 260 64" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="AuditGPT Report Review — expired">
  ...
  <text x="58" y="22" font-family="-apple-system, system-ui, sans-serif" font-size="10" font-weight="700" fill="#737373" letter-spacing="0.5">REPORT REVIEW EXPIRED</text>
...
function buildMissingSvg(): string {
  return `<?xml version="1.0" encoding="UTF-8"?>
<svg width="220" height="40" viewBox="0 0 220 40" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="No report review on file">
  <rect width="220" height="40" rx="6" fill="#f5f5f5" stroke="#d4d4d4" stroke-width="1"/>
  <text x="110" y="24" font-family="-apple-system, system-ui, sans-serif" font-size="10" font-weight="600" fill="#737373" text-anchor="middle">NO REPORT REVIEW · auditgpt.ai</text>
</svg>`;
}
