...
export default function ManualNextStep() {
  return (
    <NextStepPage
      ...
      productExplainer="When AuditGPT cannot automatically classify the gap or route it to a specific workflow — usually because the page data is too thin or the gaps are ambiguous — the right next step is a 15-minute manual review. We look at the page with you and pick a direction together."
